...
result_animation_filename = os.path.join(dir_path, '..', 'outputs', 'graphics', 'rgp_' + environment + '_' + data_filename)
...
visualiser.create_rgp_before_after(result_animation_filename)
